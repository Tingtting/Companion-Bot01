import 'package:bot01/models/category_model.dart';
import 'package:bot01/models/suggest_model.dart';
  ...
  Column _suggestSection() {
    return Column(
          ...
          children: [
            ...
            SizedBox(
              height: 15,
            ), //create space between the text and the ListView
            Container(
              height: 240,
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              'Chat',
                              style: TextStyle(
                                color: suggests[index].viewIsSelected ? Colors.white : Color(0xffC58BF2),
                                fontWeight: FontWeight.w600,
                                fontSize: 14,
                              ),
                            ),
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                suggests[index].viewIsSelected ? Color(0xff9DCEFF) : Colors.transparent,
                                suggests[index].viewIsSelected ? Color(0xff92A3FD) : Colors.transparent
                                ]
                            ),
